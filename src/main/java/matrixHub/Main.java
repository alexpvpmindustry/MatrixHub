...
public class Main extends Plugin{
    ...
    public Main() {
        ...
        Events.on(PlayerJoin.class, event -> {
            ...
            Call.label(event.player.con, "PVP", 1100f, 350f, 350f);
            Call.label(event.player.con, "SANDBOX", 1100f, 50f, 50f);
            Call.label(event.player.con, "(but its actually PVP)", 1100f, 50f, 40f);
            Call.label(event.player.con, "ATTACK", 1100f, 50f, 350f);
            Call.label(event.player.con, "(but its actually PVP)", 1100f, 50f, 340f);
            Call.label(event.player.con, "SURVIVAL", 1100f, 350f, 50f);
        });
